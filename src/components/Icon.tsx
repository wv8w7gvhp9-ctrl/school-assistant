...
type IconName = ChildTab | 'profile' | 'star' | 'clock' | 'sun' | 'backpack' | 'chevron' | 'check'
...
const paths: Record<IconName, ReactNode> = {
  ...
  clubs: <><circle cx="12" cy="12" r="3" /><path d="M4 8.5c1.8-3 5.5-4.5 9-3.7 3.5.8 5.8 3.7 5.7 6.7-.1 3.3-3.1 6.1-7 6.7-3.8.6-7.1-1.2-8-4" /><path d="M6 17.5c1.8 2.4 5.7 3.4 9.1 2.1 3.4-1.3 5.2-4.6 4.3-7.5-.9-3-4.1-4.9-7.5-4.5-3.4.4-5.9 2.8-6 5.6" /><circle cx="5" cy="8" r="1" /></>,
